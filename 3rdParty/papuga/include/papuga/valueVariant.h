...
#define papuga_init_ValueVariant(self)				{(self)->valuetype = (unsigned char)papuga_TypeVoid; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.string=0;}

/// \brief Variant value initializer as a double precision floating point value
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_double(self,val)		{(self)->valuetype = (unsigned char)papuga_TypeDouble; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.Double=(val);}

/// \brief Variant value initializer as a boolean value
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_bool(self,val)			{(self)->valuetype = (unsigned char)papuga_TypeInt; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.Int=!!(val);}

/// \brief Variant value initializer as an unsigned integer value
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_uint(self,val)			{(self)->valuetype = (unsigned char)papuga_TypeUInt; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.UInt=(val);}

/// \brief Variant value initializer as a signed integer value
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_int(self,val)			{(self)->valuetype = (unsigned char)papuga_TypeInt; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.Int=(val);}

/// \brief Variant value initializer as c string (UTF-8) reference
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_charp(self,val)		{(self)->valuetype = (unsigned char)papuga_TypeString; (self)->encoding=papuga_UTF8; (self)->classid=0; (self)->length=strlen(val); (self)->value.string=(val);}

/// \brief Variant value initializer as c string (UTF-8) reference with size
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_string(self,val,sz)		{(self)->valuetype = (unsigned char)papuga_TypeString; (self)->encoding=papuga_UTF8; (self)->classid=0; (self)->length=sz; (self)->value.string=(val);}

/// \brief Variant value initializer as unicode string reference with size and encoding
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_langstring(self,enc,val,sz)	{(self)->valuetype = (unsigned char)papuga_TypeLangString; (self)->encoding=enc; (self)->classid=0; (self)->length=sz; (self)->value.langstring=(val);}

/// \brief Variant value initializer as a reference to a host object
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_hostobj(self,objptr,clid)	{(self)->valuetype = (unsigned char)papuga_TypeHostObject; (self)->encoding=0; (self)->classid=clid; (self)->length=0; (self)->value.hostObjectData=objptr;}

/// \brief Variant value initializer as a serialization of an object defined in the language binding
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_serialization(self,ser)	{(self)->valuetype = (unsigned char)papuga_TypeSerialization; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.serialization=ser;}

/// \brief Variant value initializer as a serialization of an object defined in the language binding
/// \param[out] self pointer to structure 
#define papuga_init_ValueVariant_iterator(self,itr)		{(self)->valuetype = (unsigned char)papuga_TypeIterator; (self)->encoding=0; (self)->classid=0; (self)->length=0; (self)->value.iterator=itr;}
