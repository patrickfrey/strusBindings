...
bp::class_<StorageClient>("StorageClient")
	...
	.def("createInitPeerMessageIterator", &StorageClient::createInitPeerMessageIterator)
	.def("createUpdatePeerMessageIterator", &StorageClient::createUpdatePeerMessageIterator)
	.def("createPeerStorageTransaction", &StorageClient::createPeerStorageTransaction)
