...
bp::class_<MetaData>("MetaData")
	...
	.def("value", &MetaData::value, bp::return_value_policy<bp::copy_const_reference>())
;
...
bp::class_<SummarizerConfig>("SummarizerConfig")
	.def("defineParameter", &SummarizerConfig::defineParameter_string)
	.def("defineParameter", &SummarizerConfig::defineParameter_charp)
	.def("defineParameter", &SummarizerConfig::defineParameter_int)
	.def("defineParameter", &SummarizerConfig::defineParameter_uint)
	.def("defineParameter", &SummarizerConfig::defineParameter_double)
;
...
bp::class_<Query>("Query")
	.def("pushTerm", &Query::pushTerm)
	.def("pushExpression", &Query::pushExpression2)
	.def("pushExpression", &Query::pushExpression3)
	.def("pushExpression", &Query::pushExpression4)
	.def("pushDuplicate", &Query::pushDuplicate)
	.def("attachVariable", &Query::attachVariable)
	.def("defineFeature", &Query::defineFeature1)
	.def("defineFeature", &Query::defineFeature2)
