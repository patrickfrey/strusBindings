...
;
bp::class_<VectorStorageBuilder>("VectorStorageBuilder")
	.def("addFeature", &VectorStorageBuilder::addFeature_obj)
	.def("done", &VectorStorageBuilder::done)
	.def("run", &VectorStorageBuilder::run)
	.def("close", &VectorStorageBuilder::close)
;
...
bp::class_<Context>("Context",bp::init<>())
	...
	.def("createVectorStorageBuilder", &Context::createVectorStorageBuilder)
	.def("createVectorStorageBuilder_obj", &Context::createVectorStorageBuilder_obj)
