...
bp::class_<DocumentAnalyzer>("DocumentAnalyzer")
	...
	.def("definePatternMatcherPostProcFromFile", &DocumentAnalyzer::definePatternMatcherPostProcFromFile_obj)
...
bp::class_<QueryAnalyzer>("QueryAnalyzer")
	...
	.def("definePatternMatcherPostProcFromFile", &QueryAnalyzer::definePatternMatcherPostProcFromFile_obj)
...
bp::class_<VectorStorageClient>("VectorStorageClient")
	...
	.def("createTransaction", &VectorStorageClient::createTransaction)
...
;
bp::class_<VectorStorageTransaction>("VectorStorageTransaction")
	.def("addFeature", &VectorStorageTransaction::addFeature_obj)
	.def("defineFeatureConceptRelation", &VectorStorageTransaction::defineFeatureConceptRelation_obj)
	.def("commit", &VectorStorageTransaction::commit)
	.def("rollback", &VectorStorageTransaction::rollback)
	.def("close", &VectorStorageTransaction::close)
;
...
bp::class_<QueryEval>("QueryEval")
	...
	.def("addSummarizer", &QueryEval::addSummarizer_obj_debug)
	.def("addWeightingFunction", &QueryEval::addWeightingFunction)
	.def("addWeightingFunction", &QueryEval::addWeightingFunction_obj)
	.def("addWeightingFunction", &QueryEval::addWeightingFunction_obj_debug)
...
bp::class_<Query>("Query")
	...
	.def("setDebugMode", &Query::setDebugMode)
...
bp::class_<Context>("Context",bp::init<>())
	...
	.def("createVectorStorage", &Context::createVectorStorage_obj)
