...
def createCollectionSmart( datadir, storagename):
	storagePath = os.environ[ "PYTHONPATH" ] + "/example/" + storagename
	config = "path=%s; metadata=meta1 UINT16, meta2 UINT8, meta3 UINT8, doclen UINT16, title_start UINT8, title_end UINT8" % (storagePath)
	ctx = strus.Context()
	try:
		ctx.destroyStorage( config)
		# ... delete the storage files if they already exists
	...
	analyzer.addForwardIndexFeature( "orig", "/doc/title()", "split", "orig")
	analyzer.defineAttribute( "title", "/doc/title()", "content", "orig")
	analyzer.defineMetaData( "meta1", "/doc/meta[@id='1']()", "content", "text")
	analyzer.defineMetaData( "meta2", "/doc/meta[@id='2']()", "content", "text")
	analyzer.defineMetaData( "meta3", "/doc/meta[@id='3']()", "content", "text")
	analyzer.defineAggregatedMetaData( "title_end", ("nextpos", "endtitle"));
