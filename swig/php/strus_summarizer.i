%typemap(in) const SummarizerConfig&	(SummarizerConfig temp)
{
	...
	{
		case IS_LONG:
			SWIG_exception( SWIG_RuntimeError, "unable to convert LONG to SummarizerConfig");
			break;
		case IS_STRING:
			SWIG_exception( SWIG_RuntimeError, "unable to convert STRING to SummarizerConfig");
			break;
		case IS_DOUBLE:
			SWIG_exception( SWIG_RuntimeError, "unable to convert DOUBLE to SummarizerConfig");
			break;
		case IS_BOOL:
			SWIG_exception( SWIG_RuntimeError, "unable to convert BOOL to SummarizerConfig");
			break;
		case IS_NULL:
			break;
		case IS_ARRAY:
		...
		case IS_OBJECT:
			SWIG_exception( SWIG_RuntimeError, "unable to convert OBJECT to SummarizerConfig");
			break;
		case IS_RESOURCE:
			SWIG_exception( SWIG_RuntimeError, "unable to convert RESOURCE to SummarizerConfig");
			break;
		default: 
			SWIG_exception( SWIG_RuntimeError, "unable to convert unknown type to SummarizerConfig");
			break;
	}
	$1 = &temp;
}
