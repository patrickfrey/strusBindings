...
const char* AutomatonNameSpace::itemName( int itemid)
{
	...
	static ItemDef ar[ NofItemDefinitions+1] = {
		...
		{StorageMetadataTableCommand, "storage metadata table command"},
		{StorageMetadataTableOperation, "storage metadata table operation"},
		{StorageMetadataOldname, "storage metadata old name"},
		...
		{VectorLexemTypePriorityMap, "vector lexem type priority map"},
		{VectorLexemSpaceSubst, "vector lexem space substitution"},
		{VectorLexemLinkSubst, "vector lexem link substitution"},
		{VectorLexemCoverSimilarity, "vector lexem cover similarity"},
		{VectorLexemLshRecall, "vector lexem LSH recall"},
		...
		{FeatureExpansionDef, "feature expansion definition"},
		{FeatureExpansionTypeName, "feature expansion type name"},
		{FeatureExpansionSimilarity, "feature expansion similarity"},
		{SearchFieldName, "search field name"},
		{SearchFieldScope, "search field scope"},
		{SearchFieldSelect, "search field select"},
		{SearchFieldKey, "search field key"},
		{SearchFieldDef, "search field definition"},
		{SearchStructureName, "search structure name"},
		{SearchStructureHeader, "search structure header"},
		{SearchStructureContent, "search structure content"},
		{SearchStructureClass, "search structure class"},
		{SearchStructureDef, "search structure definition"},
		...
		{QueryEvalSummaryId, "query evaluation summary identifier"},
		...
		{QueryRankField, "query rank field"},
		{QueryRankFieldStart, "query rank field start"},
		{QueryRankFieldEnd, "query rank field end"},
