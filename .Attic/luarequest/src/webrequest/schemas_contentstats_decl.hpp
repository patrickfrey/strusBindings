 ...
 */
/* \brief Partial schema definition for document content statistics
 * @file schemas_document.hpp
 */
#ifndef _STRUS_WEBREQUEST_SCHEMAS_CONTENT_STATISTICS_DECL_HPP_INCLUDED
#define _STRUS_WEBREQUEST_SCHEMAS_CONTENT_STATISTICS_DECL_HPP_INCLUDED
