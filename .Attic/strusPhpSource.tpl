...
static zend_class_entry* g_{{classname}}_ce = NULL;
$END$

template zend_class_entry_init_c=class $END$ {{ }}
	INIT_CLASS_ENTRY(tmp_ce, "{{Project}}{{classname}}", g_{{classname}}_methods);
...
static const zend_function_entry g_{{classname}}_methods[] = {
