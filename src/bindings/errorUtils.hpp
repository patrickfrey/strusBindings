...
/// \file errorUtils.hpp
#ifndef _STRUS_BINDINGS_ERROR_UTILITIES_HPP_INCLUDED
#define _STRUS_BINDINGS_ERROR_UTILITIES_HPP_INCLUDED
#include <stdexcept>
...
#define CATCH_ERROR_MAP( contextExplainText, errorBuffer)\
	...
	{\
		(errorBuffer).report( _TXT("logic error in strus utilities: %s"), err.what());\
	}\
