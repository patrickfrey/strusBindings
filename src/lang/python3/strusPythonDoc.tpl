...
<div class="product">
	...
	<div class="product_name">{{project}} Python Bindings</div>
	...
	<div class="product_description">Python interface for strus, a set of libraries and programs to build a text search engine</div>
</div> <!-- product -->
<!-- Menu -->
