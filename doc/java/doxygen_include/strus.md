...
\section QueryNoAnalyzer Retrieve a ranklist with a simple query consisting of some terms. The query
evaluation scheme used for ranking the results is BM25. The policy that decides what to return is
