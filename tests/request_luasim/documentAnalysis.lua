...
docanaconf = call_server_checked_det_json( "GET", ISERVER1 .. "/docanalyzer/test" )
...
docana = call_server_checked_det_json( "GET", ISERVER1 .. "/docanalyzer/test", "@" .. testdoc )
if verbose then io.stderr:write( string.format("- Document '%s' analyzed:\n%s\n", testdoc, docana)) end

checkExpected( docanaconf .. docana, "@documentAnalysis.exp", "documentAnalysis.res" )
